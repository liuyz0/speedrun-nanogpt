    ...
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            ...
            for p in group["params"]:
                ...
                norm2 = (m * m).sum(dim=-1, keepdim=True).clamp_min(eps * eps)
                inv_norm = norm2.rsqrt()

                update = m * inv_norm  # unit vector in orthogonal direction
...
optimizer3 = Roar(embed_params, lr=0.002, beta=0.8, eps=1e-10)
